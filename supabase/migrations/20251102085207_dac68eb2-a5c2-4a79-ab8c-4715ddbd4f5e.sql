-- ============================================
-- WEEK 1 DAY 1-2: CRITICAL BLOCKERS FIX (v2)
-- ============================================
...
-- 2. PREVENT FREE TIER BYPASS: Trigger to validate pricing based on user tier
...
DROP TRIGGER IF EXISTS validate_template_pricing_trigger ON public.survey_templates;
...
DROP TRIGGER IF EXISTS prevent_duplicate_template_trigger ON public.survey_templates;
