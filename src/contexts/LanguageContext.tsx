...
const translations = {
  en: {
    ...
    view: "View",
    qrCode: "QR Code",
    qrCodeDesc: "Scan this QR code to access the survey",
    scanToAccess: "Scan this QR code to access the survey",
    close: "Close",
    surveyInvitation: "Survey Invitation",
    surveyEmailBody: "Please take a moment to complete this survey:",
    surveyWhatsAppMsg: "Please complete this survey",
    checkOutSurvey: "Check out this survey",
    shareWithOthers: "Share this survey with others",
    totalResponses: "Total Responses",
    activeSurveys: "Active Surveys",
    expiredSurveys: "Expired Surveys",
    extendExpiry: "Extend Expiry",
    extendExpiryDesc: "Choose how many days to extend the survey expiration",
    extendByDays: "Extend by days",
    days: "days",
    extend: "Extend",
    expiryExtended: "Expiry date extended successfully",
    ...
    feedbackScope: "Application scope",
    applySingleQuestion: "Apply to this question only",
    applyMultipleQuestions: "Extend to other questions",
  ...
  it: {
    ...
    surveyPreview: "Anteprima Questionario",
    dashboard: "Dashboard",
    view: "Visualizza",
    qrCode: "Codice QR",
    qrCodeDesc: "Scansiona questo codice QR per accedere al questionario",
    scanToAccess: "Scansiona questo codice QR per accedere al questionario",
    close: "Chiudi",
    surveyInvitation: "Invito al questionario",
    surveyEmailBody: "Per favore, dedica un momento per completare questo questionario:",
    surveyWhatsAppMsg: "Per favore completa questo questionario",
    checkOutSurvey: "Dai un'occhiata a questo questionario",
    shareWithOthers: "Condividi questo questionario con altri",
    totalResponses: "Risposte Totali",
    activeSurveys: "Questionari Attivi",
    expiredSurveys: "Questionari Scaduti",
    extendExpiry: "Estendi Scadenza",
    extendExpiryDesc: "Scegli di quanti giorni estendere la scadenza del questionario",
    extendByDays: "Estendi di giorni",
    days: "giorni",
    extend: "Estendi",
    expiryExtended: "Data di scadenza estesa con successo",
    ...
    feedbackScope: "Ambito di applicazione",
    applySingleQuestion: "Applica solo a questa domanda",
    applyMultipleQuestions: "Estendi ad altre domande",
